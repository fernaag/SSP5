...
def results_to_iamc_jsn(model, scen, scenario, region, database, l_year=2050):
    #Function above rewritten to take scenario as input
	#24.10.19 - JSN
	#parameter scen is message_ix instance
